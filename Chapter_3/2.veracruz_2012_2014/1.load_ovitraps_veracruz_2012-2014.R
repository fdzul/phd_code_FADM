...
system.time(x <- load_ovitraps_readings(path = "1.Datasets/ovitraps_2012_2014",
                                        years = c("2012", "2012", "2014"),
                                        header = TRUE))
library(data.table)
...
ovitraps_ver_2012_2014 <- x[ver_sf,]


# 7. save the results ###
save(ovitraps_ver_2012_2014, file = "8.RData/ovitraps_ver_2012_2014.RData")
